        ...
        if(r != null) {
            ...
            try {
                if(this.activeCol == null){
                    this.path = String.format("/Users/leshanchen/James/CS/lab-work/2024.12_cardinality_estimation/datasets/pqo-run/BoundSketch/%s_sketches/2d%s_[%s]_[%d|%d]_[%s|%s].txt",
